...
background: linear-gradient(90deg, transparent 15%, rgba(45, 212, 191, 0.5) 50%, transparent 85%);

/* Soft ambient glow — used behind featured elements */
background: radial-gradient(50% 50% at 50% 50%, rgba(45, 212, 191, 0.08) 0%, transparent 100%);
