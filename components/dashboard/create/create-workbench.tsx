                ...
                {history.length === 0 ? (
                  ...
                  history.map((item) => (
                    ...
                    >
                      ...
                      />
                      <span
                        className="pointer-events-none absolute left-3 top-3 flex h-6 w-6 items-center justify-center rounded-full bg-primary/85 text-primary-foreground backdrop-blur"
                        aria-label="Expand"
                        title="Expand"
                      >
